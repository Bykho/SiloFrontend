...
import StudentProfileEditor from './frontend/pages/StudentProfileEditorPage/StudentProfileEditor';
      ...
      <UserProvider>
        <div style={appStyle}>
          ...
          <Routes>
            ...
            <Route path="/studentProfileEditor" element={<ProtectedRoute component={StudentProfileEditor} />} />
